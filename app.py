...
import json
import os
import processor  # Make sure processor.py is in the same folder
...
@app.route("/clinician-home")
def clinician_home():
    return render_template("clinician_home.html")

@app.route("/clinician-profile")
def clinician_profile():
    return render_template("clinician_profile.html")
